            ...
            <form onSubmit={handleUpdateCoffee}>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
                    ...
                    <fieldset className="fieldset bg-base-200 border-base-300 rounded-box border p-4">
                        ...
                        <input type="text" name='price' defaultValue={price} className="input w-full" placeholder="Price for per cup" />
                    </fieldset>
                    <fieldset className="fieldset bg-base-200 border-base-300 rounded-box border p-4">
                ...
                <input type="submit" className="btn border-[#331A15] bg-[#D2B48C] btn-warning w-full" value='Update Coffee' />
            </form>
        </div>
    );
};
